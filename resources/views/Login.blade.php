...
<body>
    <div class="login-page d-flex flex-column align-items-center mt-5">
        ...
        <div class="login-form d-flex flex-column justify-content-center">
            <form action="" method="">
                <div>
                    <input type="email" class="form mw-100 h-25" placeholder="Phone, mail, or username ">
                </div>
                <div>
                   <input type="password" class="form mw-100 h-25" aria-describedby="emailHelp" placeholder="Password">
                 </div>
                <div class="btn-form">

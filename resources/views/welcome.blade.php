...
<body>
    <section>
        <div class="row page">
            ...
            {{--            end of Left-section--}}
            {{--            right-section--}}
            <div class="right-section bg-white d-flex justify-content-center m-auto align-items-center h-100 w-50">
                <div class="bg-white">
                   <div class="container-edit d-flex flex-column w-75  justify-content-center m-auto">
                       ...
                       <div class="h3-right-section mt-5">
                           <h3>See what’s happening in the world right now</h3>
                       </div>
                       <div class="p-right-section mt-5">
                           <p>Join Twitter today.</p>
                       </div>
                      <div class="right-section-buttons">
                          <button type="button" class="btn btn-primary btn-lg btn-block" id="signupBtn" data-toggle="modal" data-target="#exampleModalCenter">Signup</button>
                          <button type="button" class="custom-btn btn btn-secondary btn-lg btn-block" onclick="document.location='login'">Login</button>
                          <!-- Modal -->
                                  ...
                                  <div class="modal-content">
                                      <div class="modal-body">
                                          <div class="signup-body">
                                              <div class="row">
                                                  <div class="container centered-signup d-flex justify-content-center flex-column align-items-left ">
                                                      <div class="signup-content">
                                                          <div class="svg-icon m-auto mb-4">
                                                              <svg viewBox="0 0 24 24"
                                                                   class="svg-icon r-k200y r-jwli3a r-4qtqp9 r-yyyyoo r-np7d94 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr">
                                                                  <g>
                                                                      <path
                                                          ...
                                                          <div class="signup-form">
                                                              <form action="" method="">
                                                                  ...
                                                                  <div>
                                                                      <input type="text" class="form  w-100"
                                                                             aria-describedby="emailHelp" id="Place-holder"
                                                                             placeholder="Phone">
                                                                  </div>
                                                              </form>
                                                          </div>
                                                          <div class="use-email-phone text-left">
                                                              <button class="cus-btn" id="btn"
                                                                      onclick="ModifyPlaceHolder()">Use email instead
                                                              </button>
                                                          </div>
                                                          <div class="span-text-1 mt-5">
                                                              <span class="d-block font-weight-bold">Date of birth</span>
                                                              <span class="span-edit">This will not be shown publicly. Confirm your own age, even if this account is for a business, a pet, or something else.</span>
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
